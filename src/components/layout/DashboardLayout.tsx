...
export default function DashboardLayout() {
  ...
  return (
    <div className="bg-global-gradient flex h-screen w-full items-center justify-center overflow-hidden">
      <div className="h-[90vh] w-11/12 rounded-2xl bg-white/40 backdrop-blur-lg">
        <div className="flex h-full w-full gap-4 p-5">
          ...
          >
            <main className="flex h-full w-full flex-col overflow-hidden rounded-2xl bg-white">
              <Header />
