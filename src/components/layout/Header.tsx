        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex gap-3 text-xs font-medium text-gray-500">
            <Popover>
              ...
              <PopoverContent className="w-80" align="end">
                <div className="flex flex-col gap-3">
                  <h4 className="mb-2 leading-none font-medium">팔로워 목록</h4>
                  <div className="overlay-scrollbar flex max-h-[300px] w-full flex-col gap-3 overflow-x-hidden overflow-y-auto">
                    {followers.length === 0 ? (
            ...
            <Popover>
              ...
              <PopoverContent className="w-80" align="end">
                <div className="flex flex-col gap-3">
                  <h4 className="mb-2 leading-none font-medium">팔로잉 목록</h4>
                  <div className="overlay-scrollbar flex max-h-[300px] w-full flex-col gap-3 overflow-x-hidden overflow-y-auto">
                    {followings.length === 0 ? (
                      <div className="py-4 text-center text-gray-700">
                        아직 팔로잉이 없습니다.
